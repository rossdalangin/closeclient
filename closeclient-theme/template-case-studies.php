    ...
    <section class="container">
        <div class="reveal case-studies-grid">
            <div class="card" style="text-align: left;">
                ...
                <p>The Result: <span><?php echo esc_html( get_theme_mod( 'case_study_1_result', 'A 300% Increase in Qualified Leads in the First 90 Days.' ) ); ?></span></p>
            </div>
            <div class="card" style="text-align: left;">
                ...
                <p>The Result: <span><?php echo esc_html( get_theme_mod( 'case_study_2_result', 'A Consistent Flow of 10-15 High-Value Case Inquiries Per Month.' ) ); ?></span></p>
            </div>
        </div>
    </section>
