...
function closeclient_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'theme_options', array(
        'title'    => __( 'Theme Options', 'closeclient' ),
        'priority' => 100,
    ) );
    ...
    $wp_customize->add_setting( 'primary_color', array( 'default' => '#0A2342' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'primary_color', array(
        'label'    => __( 'Primary Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    $wp_customize->add_setting( 'accent_color', array( 'default' => '#D4AF37' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'accent_color', array(
        'label'    => __( 'Accent Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    $wp_customize->add_setting( 'body_text_color', array( 'default' => '#2E2E2E' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'body_text_color', array(
        'label'    => __( 'Body Text Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    $wp_customize->add_setting( 'header_bg_color', array( 'default' => '#FFFFFF' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_bg_color', array(
        'label'    => __( 'Header Background Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    $wp_customize->add_setting( 'header_text_color', array( 'default' => '#0A2342' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_text_color', array(
        'label'    => __( 'Header Text Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    $wp_customize->add_setting( 'footer_bg_color', array( 'default' => '#0A2342' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_bg_color', array(
        'label'    => __( 'Footer Background Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    $wp_customize->add_setting( 'footer_text_color', array( 'default' => '#FFFFFF' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'footer_text_color', array(
        'label'    => __( 'Footer Text Color', 'closeclient' ),
        'section'  => 'colors',
    ) ) );

    // Button Styles Section
    $wp_customize->add_section( 'button_styles', array(
        'title'    => __( 'Button Styles', 'closeclient' ),
        'panel'    => 'theme_options',
    ) );

    $wp_customize->add_setting( 'button_bg_color', array( 'default' => '#D4AF37' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'button_bg_color', array(
        'label'    => __( 'Button Background Color', 'closeclient' ),
        'section'  => 'button_styles',
    ) ) );

    $wp_customize->add_setting( 'button_text_color', array( 'default' => '#FFFFFF' ) );
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'button_text_color', array(
        'label'    => __( 'Button Text Color', 'closeclient' ),
        'section'  => 'button_styles',
    ) ) );

    $wp_customize->add_setting( 'button_border_radius', array( 'default' => 5 ) );
    $wp_customize->add_control( 'button_border_radius', array(
        'label'    => __( 'Button Border Radius (px)', 'closeclient' ),
        'section'  => 'button_styles',
        'type'     => 'number',
    ) );
}
